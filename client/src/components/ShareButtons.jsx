...
class ShareButtons extends React.Component {
  ...
  render() {
    ...
    let redditShareUrl = `https://www.reddit.com/submit/?url=https://archive.org/details/${this.props.identifier}&resubmit=true&title=Listen%20to%20this%20song%20from%20Internet%20Archive's%20digitized%2078s%20collection`
    ...
    return (
      <div>
        <div>
          ...
          <a class="resp-sharing-button__link" href={twitterShareUrl} target="" rel="noopener" aria-label="">
